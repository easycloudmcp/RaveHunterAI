...
Local retention is controlled by the operator for `data/raw-evidence/meta`.
The storage interface can later be implemented by Antoris OS using
S3-compatible storage without changing the connector.
